...
TRACEABLE_NODE_ATTRS = {
    ...
    "ad_format_contract": "ad_format_contract_node",
    "creative_lane_decision": "creative_lane_decision_node",
    "copy_presence_planner": "copy_presence_planner_node",
    "information_panel_planner": "information_panel_planner_node",
...
NODE_UTILIZATION_MATRIX = {
    ...
    "auto_pilot_text_overlay": {
        "includes": [
            ...
            "format_planner",
            "ad_format_contract",
            "creative_lane_decision",
            "copy_presence_planner",
            "information_panel_planner",
            "tone_binding",
