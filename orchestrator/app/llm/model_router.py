...
def select_for_premium(node_name: str, latency: LatencyBudget | None, node_allowed: list[ModelClass], plan_allowed: list[ModelClass]) -> ModelClass:
    ...
    if node_name in {"product_understanding", "image_prompt_planner", "prompt_critic", "auto_pilot_copywriting", "copy_candidate_generation", "native_creative_preflight_review"}:
