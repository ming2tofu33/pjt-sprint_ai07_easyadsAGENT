...
def get_visual_templates() -> list[VisualTemplate]:
    return [
        ...
        VisualTemplate(
            ...
            reserved_text_area_policy="clear uncluttered text area on one side",
            composition="appetizing food beautifully plated on a clean dining table",
            lighting="clean commercial food lighting with warm appetizing highlights",
            background_style="clean warm dining background",
            color_palette_hint=["#F5EFE6", "#FFFFFF", "#C8A977"],
            negative_prompt_additions=["raw meat grill", "charcoal", "cluttered tableware"],
            prompt_phrases=["appetizing plated food", "clean dining mood", "clear reserved text area"],
        ),
        VisualTemplate(
