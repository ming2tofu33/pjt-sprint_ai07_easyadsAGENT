...
def build_default_visual_strategy_profiles(
    ...
    candidates = (
        VisualStrategyProfile(
            strategy_id="generic_product_editorial",
            ...
            priority=14,
            fallback_tier=1,
            fallback_role="product_editorial",
            enabled=True,
        ),
        VisualStrategyProfile(
            strategy_id="generic_service_lifestyle",
            archetype="clean_ad_background",
            supported_domains=frozenset(
                {
                    CanonicalBusinessDomain.BEAUTY,
            ...
            supported_placements=frozenset(),
            required_tags=frozenset(),
            preferred_tags=frozenset({"clean", "neutral", "warm"}),
            excluded_tags=frozenset(),
            composition_template_id="generic_clean_ad_background",
            mood_preset_id="generic_clean_ad_background",
            copy_tone_profile_id="generic_v1",
            ...
            priority=13,
            fallback_tier=1,
            fallback_role="service_lifestyle",
            enabled=True,
        ),
        VisualStrategyProfile(
            strategy_id="generic_local_business",
            archetype="clean_ad_background",
            supported_domains=frozenset({CanonicalBusinessDomain.OTHER}),
            supported_placements=frozenset({"instagram_feed", "instagram_story", "poster", "flyer", "banner"}),
            required_tags=frozenset(),
            preferred_tags=frozenset({"clean", "trustworthy", "local"}),
            excluded_tags=frozenset(),
            composition_template_id="generic_clean_ad_background",
            mood_preset_id="generic_clean_ad_background",
            copy_tone_profile_id="generic_v1",
            ...
            priority=12,
            fallback_tier=1,
            fallback_role="local_business",
            enabled=True,
        ),
        VisualStrategyProfile(
            strategy_id="generic_information_poster",
            archetype="clean_ad_background",
            supported_domains=frozenset(CanonicalBusinessDomain),
            supported_campaign_roles=frozenset({"promotion", "announcement", "information"}),
            supported_placements=frozenset({"poster", "flyer", "banner"}),
            required_tags=frozenset(),
            preferred_tags=frozenset({"clean", "clear", "informative"}),
            excluded_tags=frozenset(),
            composition_template_id="generic_clean_ad_background",
            mood_preset_id="generic_clean_ad_background",
            copy_tone_profile_id="generic_v1",
            ...
            priority=11,
            fallback_tier=1,
            fallback_role="information_poster",
            enabled=True,
        ),
        VisualStrategyProfile(
            strategy_id="generic_brand_awareness",
            archetype="clean_ad_background",
            supported_domains=frozenset(CanonicalBusinessDomain),
            supported_campaign_roles=frozenset({"brand_awareness"}),
            supported_placements=frozenset(),
            required_tags=frozenset(),
            preferred_tags=frozenset({"clean", "premium", "brand"}),
            excluded_tags=frozenset(),
            composition_template_id="generic_clean_ad_background",
            mood_preset_id="generic_clean_ad_background",
            copy_tone_profile_id="generic_v1",
...
def build_default_visual_strategy_registry(
    *,
    ...
    version: str = "visual-strategy-registry-v2",
