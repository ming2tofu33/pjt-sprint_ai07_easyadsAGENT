...
def native_result_adapter_node(state: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "t2i_result": {
            "engine": "gpt_image_2",
            "width": int(result.get("output_width") or result.get("width") or 0),
            "height": int(result.get("output_height") or result.get("height") or 0),
            ...
            "metadata": {
                ...
                "modal_provider": result.get("provider"),
                "provider_image_path": result.get("provider_image_path"),
                "provider_width": int(result.get("provider_width") or 0),
                "provider_height": int(result.get("provider_height") or 0),
                "output_width": int(result.get("output_width") or result.get("width") or 0),
                "output_height": int(result.get("output_height") or result.get("height") or 0),
                "normalization_applied": bool(result.get("normalization_applied")),
                "normalization_mode": result.get("normalization_mode"),
